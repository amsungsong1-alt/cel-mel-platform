...
LOGFRAME_ROWS = [
    ...
    # ── Outcomes ──────────────────────────────────────────────────────────────
    {
        ...
        "indicator_statement": "% of SAWA participants reporting transition into D&F employment or self-employment within 6 months of programme exit",
        "disaggregation": "By sex; PWD status; support type received",
        "baseline_value": "0%",
        "target_annual": "30%",
        "target_lop": "86%",
        "means_of_verification": "Post-exit outcome survey; Labour market tracking panel",
        "frequency": "Bi-annual",
        "responsible": "CEL MEAL",
    ...
    },
    {
        "indicator_code": "PI.3",
        "result_level": "Outcome",
        "indicator_statement": "Number of women-led microenterprises established, operational and revenue-generating 12 months after programme support",
        "disaggregation": "By D&F sub-sector; enterprise size; region",
        "baseline_value": "0",
        "target_annual": "200",
        "target_lop": "2,500",
        "means_of_verification": "Enterprise tracking database; Field verification visits; Financial records spot-check",
        "frequency": "Annual",
        "responsible": "CEL MEAL",
        "critical_assumption": f"{_A2}; {_A3}",
    },
    {
        "indicator_code": "PI.4",
        "result_level": "Outcome",
        "indicator_statement": "% productivity improvement (output volume or revenue per worker) among supported D&F enterprises compared to baseline",
        "disaggregation": "By pillar; enterprise size; sex of owner",
        "baseline_value": "0%",
        "target_annual": "—",
        "target_lop": "≥30%",
        "means_of_verification": "Enterprise surveys; Financial and production records; Value chain assessments",
        "frequency": "Annual",
...
RAW_DATA_ANALYSIS: list[dict] = [
    ...
    # ── Outcomes ──────────────────────────────────────────────────────────────
    {
        "indicator_code": "PI.2",
        "data_type": "Performance",
        "target_value": "30% (Y1); 86% (LoP)",
        "trigger_value": "30",
        "problem_definition": (
            "Y1 transition rate below 30%; labour market absorption slower than programme model"
        ),
        "baseline_collected": "N", "baseline_value": "",
        "actual_q1": "", "actual_q2": "", "actual_q3": "", "actual_q4": "",
        "actual_year": "",
    ...
    },
    {
        "indicator_code": "PI.3",
        "data_type": "Performance",
        "target_value": "200 (Y1); 2,500 (LoP)",
        "trigger_value": "200",
        "problem_definition": (
            "Fewer than 200 operational women-led microenterprises at 12 months post-support"
        ),
        "baseline_collected": "N", "baseline_value": "",
        "actual_q1": "", "actual_q2": "", "actual_q3": "", "actual_q4": "",
        "actual_year": "",
    ...
    },
    {
        ...
        "trigger_value": "10",
        "problem_definition": (
            "No measurable productivity gain at Y1 midpoint; PI.4 LoP target "
...
REVIEW_PROTOCOLS: list[dict] = [
    # ── Performance ───────────────────────────────────────────────────────────
    {
        ...
        "review_scope":          (
            ...
            "PI.11, PII.R5, PII.R6, PII.R7, PIII.R1, PIII.R2, PIII.R3"
        ),
...
DATA_COLLECTION_PLAN: list[dict] = [
    {
        ...
        "rationale": (
            ...
            "confirms programme meets its PWD inclusion commitment (Pll.R5 — 8 jobs Y1)"
        ),
    ...
    },
    {
        ...
        "indicator_statement": (
            ...
            "compared to previous year (PI.4 — ≥30% productivity improvement LoP)"
        ),
        "data_points": "Enterprise ID; production volume; revenue; headcount; year",
        "rationale": (
            "Tracks PI.4 productivity outcome; annual timing captures the full production "
            "cycle and avoids seasonal distortion in the comparison"
        ),
        "instrument_status": "New",
        "instrument_link": "https://kf.kobotoolbox.org/",
    ...
    },
    {
        ...
        "indicator_statement": (
            ...
            "income change vs baseline (PI.2 — 86% transition rate LoP)"
        ),
        "data_points": "Monthly income (GHS); income source; weeks worked; sex; PWD status",
        "rationale": (
            "Tracks OC1 outcome (increased income); disaggregation by sex and PWD status "
            "enables equity analysis; bi-annual timing captures seasonal variation"
        ),
        "instrument_status": "Existing",
        "instrument_link": "https://kf.kobotoolbox.org/",
        "journey_step": "6-month follow-up",
    ...
    },
    {
        ...
        "indicator_statement": (
            ...
            "revenue sustainability vs programme-exit baseline (PI.3)"
        ),
        "data_points": "Operational status; revenue vs exit-baseline; employment headcount; sex of owner",
        "rationale": (
            "Tests whether enterprise growth persists post-programme exit; "
    ...
    },
    {
        ...
        "indicator_statement": (
            ...
            "seasonal variation (PIII.R2 — 50,000 MT additional/year LoP)"
        ),
