...
PARTNER_TARGETS = [
    ...
    {"partner_name": None, "level": 2, "metric_label": "WAN forum engagements (awareness campaigns/road shows, institutionalize occupational health standards)", "target_value": "500", "unit": "campaigns/roadshows, sites/partners covered", "time_basis": "Year 1", "source_doc": "CEL's contribution to SAWA (Sep 2026)", "source_page": "16"},
    {"partner_name": None, "level": 2, "metric_label": "Women-led cooperatives/clusters strengthened (focal persons on GALS & EMAP)",                           "target_value": "25",  "unit": "focal persons on cooperatives",               "time_basis": "Year 1", "source_doc": "CEL's contribution to SAWA (Sep 2026)", "source_page": "16"},
